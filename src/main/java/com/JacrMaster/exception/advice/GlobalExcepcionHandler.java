package com.JacrMaster.exception.advice;

import com.JacrMaster.exception.exception.AlreadyExistsException;
...
public class GlobalExcepcionHandler {
    ...
    public ResponseEntity<Map<String, Object>> mapResponseEntity(AlreadyExistsException exception){
